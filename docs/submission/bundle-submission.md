...
**Download URL:**
https://github.com/rdryfoos/specassay/releases/download/v0.3.2/specassay-0.3.2.zip
...
```
- extensions: specassay-check@0.3.2
- presets: specassay@0.2.1
```
...
curl -L -o specassay-0.3.2.zip https://github.com/rdryfoos/specassay/releases/download/v0.3.2/specassay-0.3.2.zip
specify bundle install ./specassay-0.3.2.zip
```
...
```json
{
  "specassay": {
    ...
    "author": "Rik Dryfoos",
    "license": "MIT",
    "download_url": "https://github.com/rdryfoos/specassay/releases/download/v0.3.2/specassay-0.3.2.zip",
