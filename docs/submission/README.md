...
| Hosted catalogs with live download URLs | [`catalogs/*.json`](../../catalogs/) | assets download and install ✓ |
| Clean-project install, end to end, by bundle ID | — | [test-evidence.md](test-evidence.md) |
...
| Paste-ready issue bodies | [bundle](bundle-submission.md) · [extension](extension-submission.md) · [preset](preset-submission.md) | mirror the actual issue-form fields |

## What a human does (the actual filing) 🖐

1. File the **Extension Submission** issue → paste from
   [extension-submission.md](extension-submission.md).
2. File the **Preset Submission** issue → paste from
   [preset-submission.md](preset-submission.md).
3. File the **Bundle Submission** issue → paste from
   [bundle-submission.md](bundle-submission.md), and reference the other two
   ...
   - The form's checkboxes are all honestly tickable; the evidence for each
     is in [test-evidence.md](test-evidence.md).
