...
| Versioned release with the `specify bundle build` artifact | [v0.3.3](https://github.com/rdryfoos/specassay/releases/tag/v0.3.3): `specassay-0.3.3.zip` + component packs | built in CI by the real CLI |
